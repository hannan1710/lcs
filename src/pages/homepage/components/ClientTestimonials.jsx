      ...
      <div className="container mx-auto px-4 lg:px-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm lg:text-base text-muted-foreground max-w-xl mx-auto">
                        Hear from our satisfied clients who experienced the La
            Coiffure             difference.          {" "}
          </p>
                 {" "}
        </div>
        ...
        <div className="max-w-3xl mx-auto relative">
          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden relative">
            ...
            <button
              ...
              className="absolute left-2 lg:left-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-black/50 text-white flex items-center justify-center hover:bg-black/70"
            >
            ...
            <button
              ...
              className="absolute right-2 lg:right-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-black/50 text-white flex items-center justify-center hover:bg-black/70"
            >
